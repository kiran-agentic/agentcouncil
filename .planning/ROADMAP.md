...
- [x] 31-04-PLAN.md — Orchestrator verify-to-build retry loop, server.py runner registration, integration tests
...
Plans:
- [x] 34-01-PLAN.md — TDD failure handling: retry policy, escalation, partial checkpoints, gate-triggered promotion
